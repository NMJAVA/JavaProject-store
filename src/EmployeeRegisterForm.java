...
public class EmployeeRegisterForm extends GUIFunctinos{
	...
	public EmployeeRegisterForm(Socket socket,DataInputStream fromNetInputStram,PrintStream toNetOutputStream,Employee loggedInUser) {
			...
			addComp(mainPanel,submitBtn,2,9,1,1,GridBagConstraints.WEST,GridBagConstraints.NONE);
			backBtn=new JButton("back");
			addComp(mainPanel,backBtn,2,9,1,1,GridBagConstraints.EAST,GridBagConstraints.NONE);
